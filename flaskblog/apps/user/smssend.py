...
if __name__ == "__main__":
    """示例代码入口"""
    SECRET_ID = "86c3df1bca30807233fa487ee066c055"  # 产品密钥ID，产品标识
    SECRET_KEY = "525cd84a8f8edb204a2edc4fcb3c92ed"  # 产品私有密钥，服务端生成签名信息使用，请严格保管，避免泄露
    BUSINESS_ID = "6c0523977723472392011af551bfe3ce"  # 业务ID，易盾根据产品业务特点分配
